...
| padre       |                                                                      |
+-------------+----------------------------------------------------------------------+
| Clase       | :class:`Symfony\\Component\\Form\\Extension\\Core\\Type\\NumberType` |
+-------------+----------------------------------------------------------------------+
...
Si es necesario redondear un número presentado (basándonos en la opción ``precision``), tienes varias opciones configurables para el redondeo. Cada opción es una constante en la clase :class:`Symfony\\Component\\Form\\Extension\\Core\\DataTransformer\\IntegerToLocalizedStringTransformer`:
