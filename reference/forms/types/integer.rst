...
Por omisión, si el usuario introduce un número no entero, se redondeará hacia abajo. Hay varios métodos de redondeo, y cada uno es una constante en la en la clase :class:`Symfony\\Component\\Form\\Extension\\Core\\DataTransformer\\IntegerToLocalizedStringTransformer`:
